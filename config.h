...
static const int focusonwheel       = 0;        /* Disable mouse hover */
static const char *fonts[]          = { "monospace:size=12:antialias=true:autohint=true", "SymbolsNerdFont:size=13:antialias=true:autohint=true" };
